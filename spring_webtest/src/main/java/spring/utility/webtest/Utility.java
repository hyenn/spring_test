...
public class Utility {
	...
	public static List<String> getDay() {// 내부에서 쓰기 위한 메소드. 프라이빗으로 써도 상관x
	...
	public static String paging3(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		...
		int totalPage = (int) (Math.ceil((double) totalRecord / recordPerPage)); // 전체 페이지. 전체 그룹을 만들기 위해서 만듦
...
//		     str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
	...
	public static String paging(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		...
		_nowPage = (nowGrp * pagePerBlock) + 1; // 10개 다음 페이지로 이동
		if (nowGrp < totalGrp) { // 전체 그룹보다 작으면 다음을 만듦
	...
	public static String rpaging3(int total, int nowPage, int recordPerPage, String col, String word, int bbsno,
		...
		int pagePerBlock = 10; // 블럭당 페이지 수
		int totalPage = (int) (Math.ceil((double) total / recordPerPage)); // 전체 페이지. 전체 그룹을 만들기 위해서 만듦
		int totalGrp = (int) (Math.ceil((double) totalPage / pagePerBlock));// 전체 그룹
