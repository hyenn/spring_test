...
<table class="table">
  ...
  <li class="nav-item dropdown">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="${root}/board/create">글쓰기</a>
      <a class="dropdown-item" href="${root}/board/list">목록</a>
    </div>
  </li>
  ...
  <c:if test="${not empty id && grade=='A' }">
	     ...
	     <li id="admin"><a class="nav-link" href="${root }/team/list">팀목록</a></li>
	     <li id="admin"><a class="nav-link" href="${root }/team/create">팀등록</a></li>
  </c:if>
